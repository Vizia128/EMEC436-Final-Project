...
public class star_macro_run extends StarMacro {
  ...
  private void execute0() {
    ...
    cadModel_0.getFeatureManager().create3DSketches_2("C:\\Users\\kizan\\OneDrive\\Documents\\__MSU\\Fall 2022\\EGEN 436\\Final Project\\Airfoils\\CSV_naca\\NACA4308.csv", labCoordinateSystem_0, false, true);
    ...
    flowDirectionProfile_0.getMethod(ConstantVectorProfileMethod.class).getQuantity().setComponentsAndUnits(0.9708992810016193, 0.23948817538771897, 0.0, units_2);
    ...
    velocityMagnitudeProfile_0.getMethod(ConstantScalarProfileMethod.class).getQuantity().setValueAndUnits(0.04973300023221821, units_3);
    ...
    velocityProfile_0.getMethod(ConstantVectorProfileMethod.class).getQuantity().setComponentsAndUnits(0.04828573416751402, 0.011910465482170942, 0.0, units_3);
    ...
    tableUpdate_0.setBaseFilename("naca4308, AoA=13.856334038488221, Re=3174.5979809485953, all");
    ...
    tableUpdate_1.setBaseFilename("naca4308, AoA=13.856334038488221, Re=3174.5979809485953, rect");
    ...
    plotUpdate_0.setAnimationFilenameBase("naca4308, AoA=13.856334038488221, Re=3174.5979809485953, res");
